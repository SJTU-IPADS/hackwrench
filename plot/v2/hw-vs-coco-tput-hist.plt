...
set output "./out/hw-vs-coco-tput-hist.eps"
...
set key tmargin center horizontal Left reverse samplen 1 font "Helvetica, 11"
...
serie_num=3.0
plot "./data/hw-vs-coco-tput-hist.data" using 2:xtic(1) with histogram fill pattern 1 linestyle 1 ,\
