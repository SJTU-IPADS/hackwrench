...
set output "./out/network-message.eps"
...
plot "./data/network-message.data" using 2:xtic(1) with histogram fill pattern 1 linestyle 1 ,\
     ...
     "" using 6:xtic(1) with histogram fill pattern 4 linestyle 5,\
